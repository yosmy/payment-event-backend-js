...
exports.enrichAddCardFailEvent = exports.AddCardFailEventType = exports.AddCardFailEvent = void 0;
...
var type = "yosmy.payment.add_card_fail";
exports.AddCardFailEventType = type;

var AddCardFailEvent = function AddCardFailEvent(_ref) {
  var ui = _ref.ui,
  ...
  return /*#__PURE__*/_react["default"].createElement(ui.layout, {
    label: /*#__PURE__*/_react["default"].createElement(_ui.Text, null, "El usuario intent\xF3 a\xF1adir la tarjeta"),
    ...
    })), !hide.fingerprint && /*#__PURE__*/_react["default"].createElement(_event.EventInvolved, {
      label: "Fingerprint"
    }, /*#__PURE__*/_react["default"].createElement(_ui.Text, {
      onClick: function onClick() {
        onSelectInvolved("fingerprint", involved.fingerprint);
      }
...
exports.AddCardFailEvent = AddCardFailEvent;
AddCardFailEvent.propTypes = {
  ...
  involved: _propTypes["default"].shape({
    ...
    fingerprint: _paymentBackend.enrich.FingerprintProp
  }).isRequired,
  hide: _propTypes["default"].shape({
    user: _propTypes["default"].bool,
    fingerprint: _propTypes["default"].bool
  }).isRequired,
...
var enrichAddCardFailEvent = /*#__PURE__*/function () {
  ...
  return function enrichAddCardFailEvent(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.enrichAddCardFailEvent = enrichAddCardFailEvent;